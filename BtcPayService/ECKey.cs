...
namespace BTCPayAPI
{
    ...
    public class EcKey
    {
        ...
        {
            Debug.Log("ExtractPrivateKeyFromAsn1():Entering");
        ...
        private static BigInteger ExtractPrivateKeyFromAsn1(byte[] asn1PrivKey)
        {
            ...
            // } ASN1_SEQUENCE_END(EC_PRIVATEKEY)
            //
            Debug.Log("ExtractPrivateKeyFromAsn1():Enter");
            ...
            Debug.Log("ExtractPrivateKeyFromAsn1():Returning");
